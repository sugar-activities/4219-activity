...
def message_window():
    ...
    myfont = pangofont.PangoFont(size=threades.resize_pt(19),bold=True)
    ...
    while True:
        ...
        if text:
            ...
            win = gui.Window(position = position_win, size = size_win, parent = threades.desktop, text = _("Message ") ,style = win_style ,closeable = False ,shadeable = False,moveable = False)
...
class starting_intro:
    ...
    def main_menu(self,pause_flag = True):
        ...
        if self.pause_flag:
            self.start_button = gui.Button(position = threades.resize_pos((500,500)), size = threades.resize_pos((200,30)), parent = desktop2, text = _("Start New Game"),style = self.button_style)
            self.start_button.onClick = self.startup_text
        else:
            self.resume_button = gui.Button(position = threades.resize_pos((500,500)), size = threades.resize_pos((200,30)), parent = desktop2, text = _("Resume Game"),style = self.button_style)
        ...
        self.controls_button = gui.Button(position = threades.resize_pos((500,600)), size = threades.resize_pos((200,30)), parent = desktop2, text = _("Controls"),style = self.button_style)
        self.exit_button = gui.Button(position = threades.resize_pos((500,650)), size = threades.resize_pos((200,30)), parent = desktop2, text = _("Exit"),style = self.button_style)
        self.instructions_button = gui.Button(position = threades.resize_pos((500,550)), size = threades.resize_pos((200,30)), parent = desktop2, text = _("Guide"),style = self.button_style)
        self.about_us_button = gui.Button(position = threades.resize_pos((1000,20)), size = threades.resize_pos((150,30)), parent = desktop2, text = _("About Us"),style = self.button_style)
    ...
    def instructionsWindow(self,button = None):
        ...
        myfont1 = pangofont.PangoFont(size=threades.resize_pt(40))#,bold=True)
        ...
        # Creating window
        self.win = gui.Window(position = position_win, size = size_win, parent = desktop2, text = _("     Guide") , style = win_style, shadeable = False, closeable = False,moveable = False)
        ...
        myfont2 = pangofont.PangoFont(size=threades.resize_pt(20),bold=True)
        labelStyleCopy = gui.defaultLabelStyle.copy()
        ...
        self.skip_button = gui.Button(position = threades.resize_pos((500,550),(900.0,600.0),self.win.size), size = threades.resize_pos((80,30),(900.0,600.0),self.win.size), parent = self.win, text = _("  Skip  "),style = self.button_style)
        self.next_button = gui.Button(position = threades.resize_pos((380,550),(900.0,600.0),self.win.size), size = threades.resize_pos((80,30),(900.0,600.0),self.win.size), parent = self.win, text = _("  Next > "),style = self.button_style)
        self.prev_button = gui.Button(position = threades.resize_pos((260,550),(900.0,600.0),self.win.size), size = threades.resize_pos((80,30),(900.0,600.0),self.win.size), parent = self.win, text = _("  < Prev  "),style = self.button_style)
    ...
    def aboutUsWindow(self,button = None):
        ...
        # Creating window
        self.win = gui.Window(position = position_win, size = size_win, parent = desktop2, text = _('     About Us ') , style = win_style, shadeable = False, closeable = False,moveable = False)
        self.win.onClose = lambda button: self.main_menu(self.pause_flag)
        #self.win.surf.set_alpha(140) This seems to be redundant as translucency doesnt seems to work properly
        ...
        self.close_button = gui.Button(position = threades.resize_pos((500,550),(900.0,600.0),self.win.size), size = threades.resize_pos((80,30),(900.0,600.0),self.win.size), parent = self.win, text = _("  Close  "),style = self.button_style)
    ...
    def startup_text(self,button = None):
        ...
        myfont = pangofont.PangoFont(size=threades.resize_pt(28),bold=True)
        win_style = gui.defaultWindowStyle.copy()
        win_style['font'] = myfont
        ...
        win = gui.Window(position = position_win, size = size_win, parent = desktop2, text = _(" FOODFORCE II : ESCAPING POVERTY  ") ,style = win_style,shadeable = False, closeable = False,moveable = False)
        self.startup_text_run = True
        win.surf.set_alpha(100)
        myfont2 = pangofont.PangoFont(size=threades.resize_pt(21),bold=True)
        ...
        self.skip_button = gui.Button(position = threades.resize_pos((600,550),(800.0,600.0),win.size), size = threades.resize_pos((150,30),(800.0,600.0),win.size), parent = win, text = _("  Skip  "),style = button_style)
    ...
    def controls(self,button = None):
        ...
        # Creating window
        self.win = gui.Window(position = position_win, size = size_win, parent = desktop2, text = _("     Controls ") , style = win_style, shadeable = False, closeable = False)
        self.win.onClose = lambda button: self.main_menu(self.pause_flag)
        self.win.surf.set_alpha(140)

        control_text = """\n\n"""+_("""  Setup Facility           :       s""")+""" \n\n"""+_("""  Upgrade Facility       :       u """)+"""\n\n  """+_("""Buy/Sell                    :       b""")+""" \n\n"""+_("""  Scroll threades.screen up       :       up arrow """)+"""\n\n"""+_("""  Scroll threades.screen down   :       down arrow""")+""" \n\n"""+_("""  Scroll threades.screen left      :       left arrow""")+""" \n\n"""+_("""  Scroll threades.screen right    :       right arrow """)
        myfont2 = pangofont.PangoFont(size=threades.resize_pt(25),bold=True)
        labelStyleCopy = gui.defaultLabelStyle.copy()
        labelStyleCopy['border-width'] = 1
        labelStyleCopy['wordwrap'] = True
        labelStyleCopy['autosize'] = False
        ...
        labelStyleCopy['border-color'] = self.black_color
        self.message_label = gui.Label(position = threades.resize_pos((80,80),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Setup Facility "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,130),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Upgrade Facility "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,180),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Buy/Sell "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,230),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Scroll Screen up "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,280),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Scroll Screen down"), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,330),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Scroll Screen left "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,380),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Scroll Screen right "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,430),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("Focus "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((80,480),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("De Focus "), style = labelStyleCopy)

#### NOTE: The ':' have been removed temporarily. Later they can easily be included by simply making a new label type say, labelStyleCopy2,
      #### and labelStyleCopy2['font']=pygame.font.Font(pygame.sysFont.defaultFont(),size)
        ...
        self.message_label = gui.Label(position = threades.resize_pos((350,230),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("up arrow "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((350,280),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("down arrow "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((350,330),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("left arrrow "), style = labelStyleCopy)
        self.message_label = gui.Label(position = threades.resize_pos((350,380),(600.0,600.0),self.win.size),size = threades.resize_pos((240,70),(600.0,600.0),self.win.size), parent = self.win, text = _("right arrow "), style = labelStyleCopy)
        ...
        self.ok_button = gui.Button(position = threades.resize_pos((480,550),(600.0,600.0),self.win.size), size = threades.resize_pos((80,30),(600.0,600.0),self.win.size), parent = self.win, text = _("  OK  "),style = self.button_style)
...
def main():
    ...
    while True:
        ...
        print _('this will test localisation in the log')
        mouse_flag = False
