...
class setup_button:
    ...
    def setup(self,button=None):
        ...
        myfont = pangofont.PangoFont(size=threades.resize_pt(23))
        ...
        # Creating window
        self.win = gui.Window(position = position_win, size = size_win, parent = threades.desktop, text = _("Set up a facility for your village ") ,style = win_style,shadeable = False)
        ...
        myfont2 = pangofont.PangoFont(size=threades.resize_pt(22))
        myfont3 = pangofont.PangoFont(size=threades.resize_pt(20))
        ...
        default_text = _('What would you like to set up? Choose a facility from the list and press the Set Up button.')
        ...
        text =_('Please select a Facility to see its status and Requirements') 
        ...
        self.housing_box = gui.OptionBox(position = position_optionbox, parent = self.win, style = op_style, text = _('House'))
        self.housing_box.onClick =  self.on_select_setup_option_box
        self.hospital_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(10)), parent = self.win, style = op_style, text = _('Hospital'))
        self.hospital_box.onClick = self.on_select_setup_option_box
        self.workshop_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(10)), parent = self.win, style = op_style, text = _('Workshop'))
        self.workshop_box.onClick = self.on_select_setup_option_box
        self.school_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(10)), parent = self.win, style = op_style, text = _('School'))
        self.school_box.onClick = self.on_select_setup_option_box
        self.farm_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(10)), parent = self.win, style = op_style, text = _('Farm'))
        self.farm_box.onClick = self.on_select_setup_option_box
        self.fountain_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(10)), parent = self.win, style = op_style, text = _('Well'))
        ...
        self.button_setup = gui.Button(position = threades.resize_pos((600.0,420.0),(800.0,600.0),size_win), size = threades.resize_pos((120.0,50.0),(800.0,600.0),size_win), parent = self.win, text = _("Set Up"),style = button_style)
    ...
    def setup_facility(self,button=None):
        ...
        if self.housing_box.value:
            ...
            label_text = _(' Please select a Facility for building')
        self.message_label.text = label_text
        if label_text== _('Facility has been build'):
            self.close_win()

    def build_facility_farm(self):

        myfont = pangofont.PangoFont(size=threades.resize_pt(25))
        ...
        # Creating window
        self.child_win = gui.Window(position = position_win, size = size_win, parent = threades.desktop, text = _("Setup Farm ") ,style = win_style,shadeable = False,moveable = False)
        ...
        myfont2 = pangofont.PangoFont(size=threades.resize_pt(25))
        ...
        label_rice = gui.Label(position = threades.resize_pos((100.0,260.0),(600.0,400.0),self.child_win.size), parent = self.child_win, text = _('Rice'), style = labelstyle1)
        label_veg = gui.Label(position = threades.resize_pos((250.0,260.0),(600.0,400.0),self.child_win.size), parent = self.child_win, text = _('Fruit and \nVegetables'), style = labelstyle1)
        label_beans = gui.Label(position = threades.resize_pos((400.0,260.0),(600.0,400.0),self.child_win.size), parent = self.child_win, text = _('Beans'), style = labelstyle1)
        ...
        text = _('Balance the bar chart to select the percentages of different food items you want to grow in your farm')
        ...
        self.button_setup_farm = gui.Button(position = threades.resize_pos((500.0,320.0),(600.0,400.0),size_win), size = threades.resize_pos((80.0,50.0),(600.0,400.0),size_win), parent = self.child_win, text = _("Set Up"),style = button_style)
...
class upgrade_button:
    ...
    def upgrade(self,button=None):
        ...
        # Creating window
        self.win = gui.Window(position = position_win, size = size_win, parent = threades.desktop, text = _("Upgrade Facility ") ,style = win_style,shadeable = False)
        self.win.surf.set_alpha(140) 
        self.win.onClose = lambda button: self.close_win_safe()
        self.win_flag = True
        ...
        labelStyleCopy['font-color'] = self.rect_color
        labelStyleCopy['border-color'] = self.color_grey
        text = _('Please select a Facility and press Upgrade button to upgrade.')
        ...
        myfont3 = pangofont.PangoFont(size=threades.resize_pt(20))
        text =_('Please select a Facility to see its next upgrade') 
        labelStyleCopy2 = gui.defaultLabelStyle.copy()
        labelStyleCopy2['border-width'] = 1
        labelStyleCopy2['wordwrap'] = True
        labelStyleCopy2['autosize'] = False
        ...
        self.button_upgrade = gui.Button(position = threades.resize_pos((600.0,420.0),(800.0,600.0),size_win), size = threades.resize_pos((120.0,50.0),(800.0,600.0),size_win), parent = self.win, text = _("Upgrade"),style = button_style)
        #self.button_close = gui.Button(position = threades.resize_pos((600.0,460.0),(800.0,600.0),size_win), size = threades.resize_pos((120.0,50.0),(800.0,600.0),size_win), parent = self.win, text = "Close",style = button_style)
        #self.button_close.onClick  = self.close_win
    ...
    def on_select_upgrade_option_box(self,button):
        ...
        #self.win.surf.blit(display_image,threades.resize_pos((450,250)))
        self.message_label2.text = text
        self.message_label.text = _('Upgrades ') + button.text
    ...
    def upgrade_facility(self,button=None):
        ...
        if self.housing_box.value:
            ...
            label_text = _(' Please select a Facility for Upgrading')
        self.message_label.text = label_text
        if label_text== _('Facility has been upgraded'):
            self.close_win()
...
class buysell_button:
    ...
    def buysell(self,button=None):
        ...
        gui_obj.disable_buttons()
        myfont = pangofont.PangoFont(size=threades.resize_pt(20))
        ...
        # Creating window
        self.win = gui.Window(position = position_win, size = size_win, parent = threades.desktop, text = _(" Buy or Sell Resources ") ,style = win_style,shadeable = False, moveable = False)
        self.win.surf.set_alpha(140) 
        self.win.onClose = lambda button: self.close_win_safe()
        self.win_flag = True
        ...
        heading_label1 = gui.Label(position = threades.resize_pos((10.0,70.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Resources'), style = labelstyle1)
        heading_label2 = gui.Label(position = threades.resize_pos((180.0,70.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Village'), style = labelstyle1)
        heading_label3 = gui.Label(position = threades.resize_pos((180.0,85.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Quantity'), style = labelstyle1)
        heading_label4 = gui.Label(position = threades.resize_pos((370.0,70.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Price'), style = labelstyle1)
        ...
        heading_label6 = gui.Label(position = threades.resize_pos((270.0,70.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Market'), style = labelstyle1)
        heading_label7 = gui.Label(position = threades.resize_pos((270.0,85.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Quantity'), style = labelstyle1)
        ...
        self.water_box = gui.OptionBox(position = position_optionbox, parent = self.win, style = op_style, text = _('Water'))
        self.buildmat_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Building Materials'))
        self.tools_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Tools'))
        self.books_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Books'))
        self.medicine_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Medicines'))
        self.rice_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Rice'))
        self.wheat_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Fruit & Vegatables'))
        self.beans_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Beans'))
        self.sugar_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Sugar'))
        self.salt_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Salt'))
        self.oil_box = gui.OptionBox(position = self.win.nextPosition(threades.resize_pt_y(7)), parent = self.win, style = op_style, text = _('Oil'))
        ...
        if test_connected():
            ...
            self.shareCheckBox = gui.CheckBox(position = threades.resize_pos((440, 140), (800, 600), self.win.size),  parent = self.win,  style = ch_style,  text = _('Trade with Peer Villages') )
        ...
        self.label_quantity = gui.Label(position = threades.resize_pos((440.0,170.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Quantity '), style = labelstyle1)
                    
        if test_connected():
            if self.shareCheckBox.value:
                self.label_price = gui.Label(position = threades.resize_pos((400.0,250.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Price '), style = labelstyle1)
        ...
        self.button_buy = gui.Button(position = threades.resize_pos((560.0,350.0),(800.0,600.0),size_win), size = threades.resize_pos((70.0,50.0),(800.0,600.0),size_win), parent = self.win, text = _(" Buy "),style = button_style)
        self.button_sell = gui.Button(position = threades.resize_pos((460.0,350.0),(800.0,600.0),size_win), size = threades.resize_pos((70.0,50.0),(800.0,600.0),size_win), parent = self.win, text = _(" Sell "),style = button_style)
        self.button_close = gui.Button(position = threades.resize_pos((650.0,500.0),(800.0,600.0),size_win), size = threades.resize_pos((120.0,50.0),(800.0,600.0),size_win), parent = self.win, text = _("Close"),style = button_style)
        ...
        labelStyleCopy['font-color'] = self.rect_color
        labelStyleCopy['border-color'] = self.color_grey
        text = _('Welcome to the market of SHEYLAN, where you can trade resources. Select which item you would like to buy or sell on the left-hand column, enter the amount, and then choose buy or sell')
        ...
        if test_connected():
            if self.shareCheckBox.value:
                ...
                if not self.label_res_price_flag:            
                    self.label_price = gui.Label(position = threades.resize_pos((440.0,250.0),(800.0,600.0),self.win.size), parent = self.win, text = _('Price '), style = labelstyle1)
                    self.label_res_price = gui.Label(position = threades.resize_pos((650.0,280.0),(800.0,600.0),self.win.size), parent = self.win, text = str(int(self.barObject.bar2Val)), style = labelstyle1)
    ...
    def buy_resources(self,button):
        ...
        if self.water_box.value:
            if not test_connected():
                ...
                if label_text == _('The Village has bought the resource you demanded'):
            ...
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(True,model.Book,quantity,price)
            ...
            label_text = _(' Please select a Resource for Trading')
    ...
    def sell_resources(self,button):
        ...
        if self.water_box.value:
            if not test_connected():
                ...
                if label_text == _('The Village has sold the resource you demanded'):
                    self.label_vwater.text = str(int(model.Water.get_vquantity()))
                    self.label_mwater.text = str(int(model.Water.get_mquantity()))
            else:
                if self.shareCheckBox.value:
            ...
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Buildmat,quantity,price)
        elif self.tools_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Tools,quantity,price)
        elif self.medicine_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Medicine,quantity,price)
        elif self.books_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Book,quantity,price)
        elif self.rice_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Rice,quantity,price)
        elif self.wheat_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Wheat,quantity,price)
        elif self.beans_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Beans,quantity,price)
        elif self.sugar_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Sugar,quantity,price)
        elif self.salt_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Salt,quantity,price)
        elif self.oil_box.value:
            if not test_connected():
                ...
                if self.shareCheckBox.value:
                    initiateTrade(False,model.Oil,quantity,price)
        else:
            label_text = _(' Please select a Resource for Trading')
        self.message_label.text = label_text
...
class gui_buttons:
    ...
    def initialize(self):
        ...
        '''
        myfont = pangofont.PangoFont(size=threades.resize_pt(17),bold=True)
        button_style = gui.defaultButtonStyle.copy()
        button_style['font'] = myfont
        self.setup_button = gui.Button(position = threades.resize_pos((50,865)), size = threades.resize_pos((200,25)), parent = threades.desktop, text = _("Setup Facility"),style = button_style)
        self.upgrade_button = gui.Button(position = threades.resize_pos((350,865)), size = threades.resize_pos((200,25)), parent = threades.desktop, text = _("Upgrade Facility"),style = button_style)
        self.buysell_button = gui.Button(position = threades.resize_pos((650,865)), size = threades.resize_pos((200,25)), parent = threades.desktop, text = _("Buy/Sell Resources"),style = button_style)
...
def initiateTrade(buysell,resource,quantity,price):
    ...
    if not buysell:
        ...
        if cost > model.money.get_money():
            gui_obj.buysell_obj.message_label.text = _(" Village doesn't have enough money to buy the resources")
            return
        ...
        if quantity > resource.get_vquantity():
            gui_obj.buysell_obj.message_label.text = _(" There are not enough resources in the village to trade")
            return
