...
class Actions:
    ...
    def showWFPWindow(self,text):
        ...
        # Creating window
        self.win = gui.Window(position = position_win, size = size_win, parent = st_desktop, text = _("    Reward") , style = win_style, shadeable = False, closeable = False,moveable = False)
